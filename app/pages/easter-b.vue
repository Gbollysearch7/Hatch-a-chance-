              ...
              >
                ...
                <div class="px-8 py-10 blur-md select-none pointer-events-none" aria-hidden="true">
                  <div class="text-center space-y-4">
                    ...
                    <p class="text-neutral-500 text-sm">Expires while promotion is live</p>
                  </div>
                </div>
              ...
              >
                ...
                <div class="px-8 py-8 text-center space-y-5">
                  ...
                  <div>
                    ...
                    <p class="text-xs text-neutral-400 mt-2">Tap to copy · Redeem before the promotion ends</p>
                  </div>
